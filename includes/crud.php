...
define('DOMAIN_URL', 'https://moi.greymatterworks.in/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_moi";  // Change as required
    private $db_pass = "Moi@2022";  // Change as required
    private $db_name = "u743445510_moi_app";    // Change as required
